...
public partial class SoftUniContext : DbContext
{
    ...
    public virtual DbSet<EmployeesSalaryHigherThan30000> EmployeesSalaryHigherThan30000s { get; set; }
    ...
    public virtual DbSet<VEmployessQuue> VEmployessQuues { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(LocalDB)\\MSSQLLocalDB;Database = SoftUni; Trusted_Connection = True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EmployeesSalaryHigherThan30000>(entity =>
        {
        ...
        modelBuilder.Entity<VEmployessQuue>(entity =>
        {
            entity.ToView("v_EmployessQuue");
        });
